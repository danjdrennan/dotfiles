...
-- Diagnostic keymaps
-- Update follows example in docs:
-- https://neovim.io/doc/user/diagnostic.html#diagnostic-on-jump-example
...
-- Enable the following language servers Feel free to add/remove any LSPs that
-- you want here. They will automatically be installed.
--
